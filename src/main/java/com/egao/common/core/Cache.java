...
public class Cache {
    ...
    private static List<Map<String, Object>> shopList = null;

    private static List<Map<String, Object>> supplierList = null;

    private static List<Map<String, Object>> colourList = null;
     ...
     * @return
     */
    public synchronized static String getShopName(String shopId) {

        if(shopList != null && shopList.size() > 0){
            for(Map<String, Object> shopMap : shopList){
                String shop_id = (String)shopMap.get("shop_id");
                String shop_name = (String)shopMap.get("shop_name");
                if(shopId.equals(String.valueOf(shop_id))){
                    return shop_name;
                }
            }
        }
    ...
    public static void setShopList(List<Map<String, Object>> shopList) {
        Cache.shopList = shopList;
    }

    public static List<Map<String, Object>> getSupplierList() {
        return supplierList;
    }

    public static void setSupplierList(List<Map<String, Object>> supplierList) {
        Cache.supplierList = supplierList;
    }

    public static List<Map<String, Object>> getColourList() {
        return colourList;
    }

    public static void setColourList(List<Map<String, Object>> colourList) {
