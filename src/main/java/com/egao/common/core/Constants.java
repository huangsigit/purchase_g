...
//    public static final int RESULT_OK_CODE = 200;  // 默认成功码
    ...
    public static final int LOCK_STATUS_OPER = 0;  // 锁定不可更新
    public static final int LOCK_STATUS_CLOSE = 1;  // 不锁定可更新


    public static final boolean DEVELOPMENT_ENVIRONMENT = true;  // true测试环境 false生产环境
