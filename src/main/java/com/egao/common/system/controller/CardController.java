...
//            , @RequestParam(name = "customerId", required = false)Long customer_id
...
/*
            ...
            System.out.println("allotRechargeAmountMap："+allotRechargeAmountMap);
...
//            BigDecimal external_amount = (BigDecimal)allotRechargeAmountMap.get("external_amount");
            ...
            Date logout_time = (Date)allotRechargeAmountMap.get("logout_time");
