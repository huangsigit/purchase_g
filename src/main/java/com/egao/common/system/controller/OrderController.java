...
public class OrderController extends BaseController {
    ...
    public String view(Model model) {
        ...
        System.out.println("system/order.html");
...
//    @RequiresPermissions("sys:order:list")
    ...
    public JsonResult list(HttpServletRequest request
        ...
        System.out.println("采购清单 分页查询数据...");
...
//        map.put("shop_name", shop_name);
        ...
        int count = 0;
        if(list.size() > 0){
            count = orderService.selectCount(map);
        ...
        System.out.println("采购清单 data:"+JSONObject.toJSON(data));
        return data;
    }
     ...
     * 添加数据
     */
    @OperLog(value = "采购清单", desc = "添加数据", result = true)
    ...
    public JsonResult add(HttpServletRequest request
        ...
        System.out.println("采购清单 add:"+request);
     ...
     * 修改数据
     */
    @OperLog(value = "采购清单", desc = "修改数据", result = true)
    ...
    public JsonResult update(HttpServletRequest request, @RequestParam(name = "id", required = false)Long id, @RequestParam(name = "outCreateTime", required = false)String outCreateTime
        ...
        System.out.println("采购清单 update:"+request);
     ...
     * 删除数据
     */
    @OperLog(value = "采购清单", desc = "删除数据", result = true)
    @RequiresPermissions("sys:order:delete")
    @ResponseBody
    @RequestMapping("/delete")
    public JsonResult remove(int id) {

        System.out.println("采购清单 删除数据 order_id："+id);
     ...
     * 同步数据
     */
    @OperLog(value = "采购清单", desc = "同步数据", result = true)
    @RequiresPermissions("sys:order:add")
    @ResponseBody
...
*/
     ...
     * 批量删除清单
     */
    @OperLog(value = "采购清单", desc = "批量删除", result = true)
    @RequiresPermissions("sys:order:delete")
    @ResponseBody
     ...
     * 批量采购
     */
    @OperLog(value = "采购清单", desc = "批量采购", result = true)
    @RequiresPermissions("sys:order:update")
    @ResponseBody
...
//            return JsonResult.error("采购失败");
     ...
     * 批量发货
     */
    @OperLog(value = "采购清单", desc = "批量发货", result = true)
    @RequiresPermissions("sys:order:update")
    @ResponseBody
     ...
     * 批量作废
     */
    @OperLog(value = "采购清单", desc = "批量作废", result = true)
    @RequiresPermissions("sys:order:update")
    @ResponseBody
    ...
    @OperLog(value = "采购清单", desc = "导出数据到excel")
//    @RequiresPermissions("sys:order:list")
    @ResponseBody
